...
export function ErrorState({ message = 'Something went wrong.', onRetry }) {
  return (
    <div className="flex flex-col font-['manrope'] tracking-wide items-center gap-3 rounded-lg border border-surface-border bg-surface px-6 py-10 text-center">
...
export function EmptyState({ message = 'Nothing to show yet.' }) {
  return (
    <div className="flex flex-col font-['manrope'] tracking-wide items-center gap-3 rounded-lg border border-dashed border-surface-border px-6 py-10 text-center">
